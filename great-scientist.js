...
//dv vs ac
function ld3(){
document.getElementById("lm").innerHTML="<table style='background-color:black;'><tr><td><p id='l1'></p></td><td><p id='l2'style='color:transparent;background-color:white;'></p></td><td></tr></table><p id='t1'style='color:yellow;background-color:green;position:fixed;top:0;left:200px;'></p>";
