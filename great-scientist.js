...
//dv vs ac
function ld3(){
document.getElementById("lm").innerHTML="<table style='background-color:black;border-radius:20px;'><tr><td><p id='l1'style='color:yellow;background-color:black;'></p></td><td><p id='l2'style='color:blue;background-color:black;'></p></td></tr></table>";
