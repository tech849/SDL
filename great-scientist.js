...
//dv vs ac
function ld3(){
document.getElementById("lm").innerHTML="<table style='background-color:black;'><tr><td><p id='l1'style='color:yellow;background-color:;'></p></td><td><p id='l2'style='color:blue;background-color:white;'></p></p></td><td></tr></table>";
